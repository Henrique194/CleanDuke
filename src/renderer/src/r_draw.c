...
void hlineasm4(int32_t numPixels, int32_t shade, uint32_t i4, uint32_t i5,
               uint8_t* dest) {
...
void setuprhlineasm4(int32_t i1, int32_t i2, int32_t i3, const uint8_t* i4,
...
void rhlineasm4(int32_t i1, const uint8_t* texture, int32_t i3, uint32_t i4,
                uint32_t i5, uint8_t* dest) {
    uint32_t ebp = 0;
    int32_t numPixels;
    int32_t offset = i1 + 1;
...
void setuprmhlineasm4(int32_t i1, int32_t i2, int32_t i3, const uint8_t* i4,
                      int32_t tileHeight, int32_t i6) {
    rmmach_eax = i1;
    rmmach_ebx = i2;
    rmmach_ecx = i3;
    rmmach_edx = i4;
...
//FCS: ????
void rmhlineasm4(int32_t i1, const uint8_t* shade, int32_t colorIndex,
                 int32_t i4, int32_t i5, uint8_t* dest) {
    uint32_t ebp = 0;
    int32_t numPixels;
    int32_t offset = i1 + 1;
...
int32_t prevlineasm1(int32_t i1, const uint8_t* palette, int32_t i3, int32_t i4,
...
int32_t vlineasm1(int32_t vince, const uint8_t* palookupoffse,
                  int32_t numPixels, int32_t vplce, const uint8_t* texture,
                  uint8_t* dest) {
    uint32_t temp;
...
int32_t tvlineasm1(int32_t i1, const uint8_t* texture, int32_t numPixels,
                   int32_t i4, const uint8_t* source, uint8_t* dest) {
...
void tvlineasm2(uint32_t i1, uint32_t i2, uintptr_t i3, uintptr_t i4,
                uint32_t i5, uintptr_t i6) {
    uint32_t ebp = i1;
...
int32_t mvlineasm1(int32_t vince, const uint8_t* palookupoffse, int32_t i3,
                   int32_t vplce, const uint8_t* texture, uint8_t* dest) {
    uint32_t temp;
...
void tsetupspritevline(const uint8_t* palette, int32_t i2, int32_t i3,
 ...
 */
void DrawSpriteVerticalLine(int32_t i2, int32_t numPixels, uint32_t i4,
...
//------------------------FLOOR/CEILING RENDERING METHOD------------------------
...
void mhline(uint8_t* texture, int32_t i2, int32_t numPixels, int32_t i4,
            int32_t i5, uint8_t* dest) {
    textureData = texture;
    mmach_asm3 = (uint8_t*) asm3;
    mmach_asm1 = asm1;
    mmach_asm2 = asm2;
...
void mhlineskipmodify(uint32_t i2, int32_t numPixels, int32_t i5,
                      uint8_t* dest) {
    uint32_t ebx;
    int32_t colorIndex;
...
void thline(uint8_t* i1, int32_t i2, int32_t i3, int32_t i4, int32_t i5,
            uint8_t* i6) {
    tmach_eax = i1;
    tmach_asm3 = (uint8_t*) asm3;
    tmach_asm1 = asm1;
    tmach_asm2 = asm2;
...
void thlineskipmodify(int32_t i1, uint32_t i2, uint32_t i3, int32_t i4,
                      int32_t i5, uint8_t* i6) {
    uint32_t ebx;
    int counter = (i3 >> 16);
    while (counter >= 0) {
        ebx = i2 >> tshift_al;
...
void slopevlin(intptr_t i1, uint32_t i2, intptr_t* i3, uint32_t index,
    ...
    do {
        ...
        while ((ecx & 0xff)) {
            ...
            edi += eax;
            i1 += slopemach_ecx;
            edx = ((edx & 0xffffff00) | ((((uint8_t*) (ebx + edx))[
                       slopemach_ebx])));
            ebx = i3[index];
            index--;
